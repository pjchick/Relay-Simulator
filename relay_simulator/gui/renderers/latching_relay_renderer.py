"""
Latching Relay component renderer.

Renders a latching relay with two coils (SET and RESET) and two sets of contacts (poles).
"""
...
class LatchingRelayRenderer(ComponentRenderer):
    """
    Renderer for LatchingRelay components.
    Supports rotation and flipping transformations.
    """
    
    WIDTH = 60   # Relay width in pixels
    HEIGHT = 240  # Relay height in pixels (taller than DPDT to fit second coil)
